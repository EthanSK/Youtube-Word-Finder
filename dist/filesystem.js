...
exports.cleanupDirs = exports.createYoutubeDlFilePath = exports.createWorkspaceFilesystem = exports.getFilesInDir = exports.getDirName = exports.createDirIfNeeded = void 0;
...
function getFilesInDir(dir) {
    return new Promise((resolve, reject) => {
        fs_extra_1.default.readdir(dir, (err, files) => {
            if (err)
                return reject(err);
