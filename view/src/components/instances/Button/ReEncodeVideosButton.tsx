      ...
      onClick={(event) => {
        ...
        if (newValue === false) {
          consoleOutputDispatch({
            ...
            payload: {
              message:
                "Will not re-encode videos after downloading them, and will copy the codec of the source. The download process may be faster, but there may be some bugs with the video, such as a frozen last frame for a few seconds",
              messageType: "info",
            },
          })
        } else {
          consoleOutputDispatch({
            ...
            payload: {
              message:
                "Will re-encode videos after downloading them. The download process may be slower, but will probably not have any issues or bugs",
              messageType: "info",
            },
          })
        }
